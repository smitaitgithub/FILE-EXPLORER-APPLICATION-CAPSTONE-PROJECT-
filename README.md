...
The project showcases the uses of the C++ filesystem library for performing dynamic file and directory operations .It serves as an excellent learning example learning example 
for understanding how real-world file management systems function.
...
• Showcasing practical implementation of the library in C++.
...
🚀 How to Run
Open Git Bash or Command Prompt inside your project folder.
Compile the code using: g++ file_explorer.cpp -o file_explorer -lstdc++fs
